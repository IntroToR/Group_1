...
The appropriate p-values for all three linear models was below the 0.05 threshold. We reject the null hypothesis and conclude that the coefficients are not equal to zero and there is a relationship between year and "sulfur levels"n_tree"/"europe_temp_index, and "n_tree" vs. "europe_temp_index" WDC.
